                    ...
                    <div className="col-12 col-sm-4">
                      <div className="form-group local-forms">
                        ...
                        >
                          ...
                          <option value="A+" defaultValue={teacher.blood_type}>
                            A+
                          </option>
                          <option value="A-" defaultValue={teacher.blood_type}>
                            A-
                          </option>
                          <option value="B+" defaultValue={teacher.blood_type}>
                            B+
                          </option>
                          <option value="B-" defaultValue={teacher.blood_type}>
                            B-
                          </option>
                          <option value="AB+" defaultValue={teacher.blood_type}>
                            AB+
                          </option>
                          <option value="AB-" defaultValue={teacher.blood_type}>
                            AB-
                          </option>
                          <option value="O+" defaultValue={teacher.blood_type}>
                            O+
                          </option>
                          <option value="O-" defaultValue={teacher.blood_type}>
                            O-
